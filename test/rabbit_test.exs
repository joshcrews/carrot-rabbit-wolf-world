...
defmodule RabbitTest do
  ...
  test "prefers moving towards carrots" do
    local_board = [
      ...
      [[:no_carrots], [:no_carrots], [:no_carrots], [:no_carrots], [:no_carrots], [:no_carrots], [:no_carrots], [:no_carrots], [:no_carrots]],
      [[:no_carrots], [:no_carrots], [:no_carrots], [:no_carrots], [:no_carrots], [:no_carrots], [:no_carrots], [:no_carrots], [:no_carrots]],
      [[:no_carrots], [:no_carrots], [:no_carrots], [:no_carrots], [:no_carrots], [:no_carrots],    [:carrots], [:no_carrots], [:wolf]],
    ]

    rabbit = %Rabbit{local_board: local_board, current_coordinates: %{x: 3, y: 3}, what_i_eat: :carrots, what_i_flee: :wolf}
    ...
    expected_result =  [[%{name: 'NW', score: 2, x: 2, y: 2}, %{name: 'W', score: 0, x: 2, y: 3}, %{name: 'SW', score: 0, x: 2, y: 4}],
                        ...
                        [%{name: 'NE', score: 0, x: 4, y: 2}, %{name: 'E', score: 0, x: 4, y: 3}, %{name: 'SE', score: -9, x: 4, y: 4}]]
